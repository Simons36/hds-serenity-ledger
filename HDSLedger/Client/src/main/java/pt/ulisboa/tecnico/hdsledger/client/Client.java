...
public class Client {
    ...
    public static void main(String[] args) {
        ...
        if (args.length != 4){
            System.out.println("Usage: mvn compile exec:java -Dexec.args=\"<clientId> <config filename> <port> <sending_policy>\"\n" + 
        ...
        final String sendingPolicy = args[3];

        // Create client service
        ClientState clientState = new ClientState(configPath, port, sendingPolicy, thisClientId);
