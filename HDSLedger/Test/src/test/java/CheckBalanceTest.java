...
public class CheckBalanceTest {
    ...
    private final static String COMMANDS_FILE = "check_balance_test.json";
    ...
    /*
     * This test launches all nodes and a client that sends one check balance request
     */
    ...
    public void testSomething() throws IOException{
        ...
        try {
            ...
            System.out.println("Check Balance Test: Success");
        } catch (IOException e) {
            throw e;
        }
