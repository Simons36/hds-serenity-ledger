...
public class Test4_ByzantineLeaderTriesToInsertInvalidFee {

    private final static String COMMANDS_FILE_CLIENT1 = "client1_config_test_behavior_4.json";

    private final static String COMMANDS_FILE_CLIENT2 = "client2_config_test_behavior_4.json";

    private final static String CONFIG_PATH = "../Common/src/main/resources/config_test_behavior_4.json";

    private final static String TEST_OUTPUT_CLIENT1 = "src/test/java/output/test_behavior_4_output_client1.txt";

    private final static String TEST_OUTPUT_CLIENT2 = "src/test/java/output/test_behavior_4_output_client2.txt";
    ...
    /*
     * This test launches all nodes, client1 tries to transfer 50 coins to client2; the leader will try to insert an invalid fee.
     * After some time, there should be a leader change and the block should be accepted.
     */
